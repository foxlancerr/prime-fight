...
function AccordionItem({
  ...
  return (
    ...
    className={cn("border-2 px-6 rounded-xl items-center cursor-pointer border-primary", className)}
      {...props}
    />
  )
}
...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <ChevronDownIcon className="text-primary pointer-events-none size-7 shrink-0 translate-y-0.5 transition-transform duration-200" />
      </AccordionPrimitive.Trigger>
